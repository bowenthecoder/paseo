...
| [docs/claude-workspace-ui-plan.md](docs/claude-workspace-ui-plan.md)                 | Requested sidebar/provider changes, screenshot review, worktree setup, and validation record                                   |
| [docs/codex-output-and-auto-title-plan.md](docs/codex-output-and-auto-title-plan.md) | Codex-style compact output, automatic titles, native name synchronization and focused acceptance plan                          |
| [docs/production-review-2026-09-09.md](docs/production-review-2026-09-09.md)         | Four chat views, account usage isolation, compact tool output and final artifact release gate                                  |
...
| [docs/side-panel.md](docs/side-panel.md)                                             | The single chat view: panel host routing, layout shape, side panel shell, header and keyboard                                  |
