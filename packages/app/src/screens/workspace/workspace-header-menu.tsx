...
import {
  WORKSPACE_DRAFTS_PAGE_ID,
  workspaceDraftsPage,
  type WorkspaceDraftMenuEntry,
} from "./workspace-draft-menu";
  ...
  return (
    <DropdownMenu>
      ...
      >
        ...
        {drafts.length > 0 ? (
          <DropdownMenuSubTrigger id={WORKSPACE_DRAFTS_PAGE_ID} testID="workspace-header-drafts">
            Drafts
          </DropdownMenuSubTrigger>
        ) : null}
        <DropdownMenuSeparator />
