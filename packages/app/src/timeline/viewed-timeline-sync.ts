...
function applyAuthoritativeTimelineResponse(input: {
  ...
  // Painted cache rows already have sequence coverage. A projected resume page can include
  // their full message, so reconcile that overlap before marking the timeline synced.
  const currentCursor =
